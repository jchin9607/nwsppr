...
const Navbar = ({loggedIn}) => {
  ...
  return (
    <div className='h-[60px] flex items-center justify-between w-full px-[5%]'>
        <Link to="/"><h1 className='font-bold md:text-4xl sm:text-2xl'>writeup.</h1> </Link>
            ...
            <details className="dropdown dropdown-end">
              <summary className="m-1 list-none cursor-pointer"><div className="avatar">
                  <div className="w-10 rounded-full bg-slate-400">
                    {avatarImage && <img src={avatarImage} alt="View Profile"/>}
                    {!avatarImage && <img src="https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_1280.png" alt="View Profile"/>}
                  </div>
                </div>
              </summary>
